...
const Footer = () => {
  return (
     ...
     <footer class="  shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 bg-indigo-600 antialiased">
  <p class="mb-4 text-sm text-center text-white  sm:mb-0">
      &copy; 2025 <a href="https://flowbite.com/" class="hover:underline" target="_blank">Financify.com</a>. All rights reserved.
  </p>
